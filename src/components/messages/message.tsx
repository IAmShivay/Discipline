...
const snackbarMessages: SnackbarMessages = {
  ...
  error: {
    ...
    leaveRequestError:
      "There was an issue with processing the leave request. Try again later.",
    attendanceError:
      "Error marking attendance. Please check the system and try again.",
    performanceReviewFailed:
      "Failed to complete the performance review. Please try again.",
    ...
    emailUpdateFailed:
      "Failed to update email address. Please verify the email and try again.",
    ...
    signupFailed:
      "Sign-up failed. Please ensure all fields are valid and try again.",
    passwordResetFailed: "Password reset failed. Please try again later.",
    emailVerificationFailed:
      "Email verification failed. Please check your inbox and try again.",
    ...
    emailAlreadyInUse:
      "This email is already associated with an existing account. Try logging in.",
    ...
    caseDeletionFailed:
      "Failed to delete the case. Please check the details and try again.",
    caseNotFound:
  ...
  info: {
    ...
    fillEmployeeDetails:
      "Please ensure all employee details are filled before proceeding.",
    reviewPerformance:
      "Review employee performance and provide feedback during appraisal cycles.",
    trackPayrollStatus:
      "You can track payroll status in the payroll dashboard.",
    ...
    updateAttendance:
      "Ensure attendance is updated regularly to avoid discrepancies.",
    trainingReminder:
      "Ensure all employees are enrolled in relevant training programs.",
    passwordChangeReminder:
      "Remember to update your password regularly for security.",
    authReminder:
      "For security purposes, make sure to log out from shared devices.",
    ...
    accountSecurityReminder:
      "For your security, enable two-factor authentication for your account.",
    emailVerificationReminder:
      "Don't forget to verify your email after signing up to complete your registration.",
    passwordResetReminder:
      "Forgot your password? Reset it by following the instructions sent to your email.",
    sessionTimeoutReminder:
      "For security, your session will expire after a period of inactivity.",
    caseStatusReminder:
      "Regularly update the case status to reflect the current progress.",
    caseDetailsInfo:
      "Ensure all necessary details are provided when creating or updating a case.",
    caseCloseInfo:
      "Once resolved, remember to close the case and notify relevant stakeholders.",
    caseDeletionWarning:
      "Deleting a case is permanent. Make sure this action is intentional.",
  },
};
